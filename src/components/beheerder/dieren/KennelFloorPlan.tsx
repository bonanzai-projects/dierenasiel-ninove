  ...
  return (
    ...
    >
      ...
      {/*
        ...
        over de onderste helft van de foto om het leesbaar te houden. Samen
        slokte dat het grootste deel van de tegel op. Nu: één smalle balk, code
        en bezetting naast elkaar, op een donkere ondergrond die genoeg
        doorlaat om de foto er nog door te zien.
